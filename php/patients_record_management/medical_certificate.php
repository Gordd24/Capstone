                                ...
                                <div class="row my-5">
                                    ...
                                    <div class="col">
                                        <form method="POST" id ='medcert_form' enctype="multipart/form-data">
                                                    ...
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <div class="row  justify-content-center">
                                                                <div class="col-4 btn shadow-lg next m-3 p-2" id="medical_personal_next_btn">
                                                                    Next
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- input group -->
                                            <div class="row input_group" id="medical_diagnosis_group">

                                                <div class="col">
                                                    <div class="row my-3 ">
                                                            <div class="col">
                                                                <h5 class='required'>Diagnosis</h5>
                                                            </div>
                                                    </div>    
                                                    ...
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <div class="row  justify-content-center">
                                                                <div class="col-4 btn shadow-lg prev m-3 p-2" id="medical_diagnosis_prev_btn">
                                                                    Previous
                                                                </div>
                                                                <div class="col-4 btn shadow-lg next m-3 p-2" id="medical_diagnosis_next_btn">
                                                                    Next
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- input group -->
                                            <div class="row input_group" id="recommendation_group">
                                                <div class="col">
                                                    <div class="row my-3">
                                                            <div class="col">
                                                                <h5 class='required'>Recommendation</h5>
                                                            </div>
                                                    </div>    
                                                    ...
                                                    <div class="row my-2">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <textarea class="form-control required" id="recommendation" name="recommendation" rows="8"></textarea>
                                                    ...
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <div class="row  justify-content-center">
                                                                <div class="col-4 btn shadow-lg prev m-3 p-2" id="recommendation_prev_btn">
                                                                    Previous
                                                                </div>
                                                                <div class="col-4 btn shadow-lg next m-3 p-2" id="recommendation_next_btn">
                                                                    Next
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- input group -->
                                            <div class="row input_group" id="physician_group">  
                                                <div class="col">
                                                    <div class="row my-3">
                                                            <div class="col">
                                                                <h5>Phycisian Information</h5>
                                                            </div>
                                                    </div>    
                                                    ...
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <label for="license" class="form-label required">Physician License</label>
                                                    ...
                                                    <div class="row my-3">
                                                        <div class="col">
                                                            <div class="row  justify-content-center">
                                                                <div class="col-4 btn shadow-lg prev m-3 p-2" id="physician_prev_btn">
                                                                    Previous
                                                                </div>
                                                                <div class="col-4 m-3">
