                        ...
                        <tbody class="cons_tbody">';
                               $record_type="consultation";
                                ...
                                while ($row = $hist_result->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    echo "<tr class='show_mods' data-complaint=\"".$cons_row['complaint']."\" data-date_consulted=\"".date("Y-m-d",strtotime($row['uploaded_date_time']))."\"  data-time_consulted=\"".date("h:i A",strtotime($row['uploaded_date_time']))."\" data-physician=\"".'Dummy Phycisian'."\" data-record_type=\"consultation\" data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\">
