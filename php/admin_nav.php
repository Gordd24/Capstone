    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav"> 
            <div> 
                ...
                <div class="nav_list"> 
                    <a href="../profile/view_profile.php" class="nav_link" id='profile_link'> <i class='bx bxs-user-circle nav_icon'></i> <span class="nav_name"><?php echo $active_account_name; ?></span> </a> 
