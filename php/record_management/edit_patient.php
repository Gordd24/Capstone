...
if(isset($_POST['edit_patient_submit'])){
    ...
    $updateSql = "UPDATE tbl_patients
                  ...
                  sex = '".$_POST['patient_sex']."', religion = '".$_POST['patient_religion']."', address='".$_POST['patient_birthday']."', occupation = '".$_POST['patient_occupation']."'  WHERE patient_id = '".$patient."';";
        ...
        <div class="record_management_div">
            ...
            <div class="record_management_edit_div">
                ...
                <div class="edit_patient_form_div">
                    ...
                    <h4>Double Click Field To Enable Edit Mode</h4> 
                    ...
                    <form class="edit_patient_form" method="POST">
                        ...
                        <input id="patient_fname" type="text" name="patient_fname" placeholder="First Name" required="" value="<?php echo $viewPatient['first_name']; ?>" readonly><br>
                        <label for="patient_mname">Middle Name</label><br>
                        <input id="patient_mname" type="text" name="patient_mname" placeholder="Middle Name (Optional)" value="<?php echo $viewPatient['middle_name']; ?>" readonly><br>
                        <label for="patient_lname">Last Name</label><br>
                        <input id="patient_lname" type="text" name="patient_lname" placeholder="Last Name" required="" value="<?php echo $viewPatient['last_name']; ?>"  readonly><br><br>      
                        <p>Sex</p>
                        ...
                        <input id="patient_contact_no" type="text" name="patient_contact_no" placeholder="Contact No. (Optional)" value="<?php echo $viewPatient['contact_no']; ?>" readonly><br>
                        <label for='patient_birthday'>Birthday:</label><br>
                        <input type='date' id='patient_birthday' name='patient_birthday' required='required' value="<?php echo $viewPatient['birthdate']; ?>" readonly><br>
                        <label for="patient_address">Address</label><br>
                        <input id="patient_address" type="text" name="patient_address" placeholder="Address" required="" value="<?php echo $viewPatient['address']; ?>" readonly><br>
                        <label for="patient_occupation">Occupation</label><br>
                        <input id="patient_occupation" type="text" name="patient_occupation" placeholder="Occupation (Optional)" value="<?php echo $viewPatient['occupation']; ?>" readonly><br>
                        <label for="patient_religion">Religion</label><br>
                        <input id="patient_religion" type="text" name="patient_religion" placeholder="Religion (Optional)" value="<?php echo $viewPatient['religion']; ?>" readonly><br><br>
