      ...
      <div class='mutable'>
        <div class='admi_cont_div age_sex_contact_address'>
            ...
            <div class='admi_cont contact'>
                ...
                <input type='text' id='patient_contact_no' name='patient_contact_no'  value='".$viewPatient['contact_no']."'>
            </div>
        </div>
        ...
        <div class='admi_cont_div room_case'>
            <div class='admi_cont room'>
                ...
                <input type='text' id='patient_room_no' name='patient_room_no'>
            </div>
            <div class='admi_cont case'>
                <label for='patient_case_no'>Case No:</label><br>
                <input type='text' id='patient_case_no' name='patient_case_no'>
            </div>
            <div class='admi_cont cs'>
                <label for='patient_cs'>CS:</label><br>
                <input type='text' id='patient_cs' name='patient_cs'>
            </div>
        </div>
        ...
        <div class='admi_cont_div religion_bday_occupation'>
            <div class='admi_cont religion'>
                ...
                <input type='text' id='patient_religion' name='patient_religion' value='".$viewPatient['religion']."'>
            </div>
            ...
            <div class='admi_cont occupation'>
                ...
                <input type='text' id='patient_occupation' name='patient_occupation' value='".$viewPatient['occupation']."' required='required'>
            </div>
        </div>
        
        <div class='admi_cont philhealth'>
            <label for='patient_philhealth_no'>Philhealth No:</label><br>
            <input type='text' id='patient_philhealth_no' name='patient_philhealth_no'>
        </div>
        
        <div class='admi_cont_div father_mother'>
            <div class='admi_cont father'>
                <label for='patient_father_name'>Father's Name:</label><br>
                <input type='text' id='patient_father_name' name='patient_father_name' required='required'>
            </div>
            <div class='admi_cont mother'>
                <label for='patient_mother_name'>Mother's Name:</label><br>
                <input type='text' id='patient_mother_name' name='patient_mother_name' required='required'>
            </div>
        </div>
        ...
        <div class='admi_cont_div spouse'>
            ...
            <div class='admi_cont spouse'>
                ...
                <input type='text' id='patient_spouse_name' name='patient_spouse_name'>
            </div>
            <div class='admi_cont date_marriage'>
                <label for='patient_date_of_marriage'>Date Of Marriage (Optional):</label><br>
                <input type='date' id='patient_date_of_marriage' name='patient_date_of_marriage'>
            </div>
            <div class='admi_cont place_marriage'>
                <label for='patient_place_of_marraige'>Place Of Marriage (Optional):</label><br>
                <input type='text' id='patient_place_of_marraige' name='patient_place_of_marriage'>
            </div>
        ...
        <div class='admi_cont_div admitted'>
            ...
            <div class='admi_cont admitted_by'>
                ...
                <input type='text' id='patient_admitted_by' name='patient_admitted_by' required='required'>
            </div>
        </div>
